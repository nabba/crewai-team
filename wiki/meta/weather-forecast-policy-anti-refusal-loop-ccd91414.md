---
aliases:
- weather forecast policy anti refusal loop ccd91414
...
relationships: []
section: meta
source: workspace/skills/_____weather_forecast_policy__anti-refusal_loop___ccd91414.md
status: active
tags:
- self-improvement
- skills
- auto-synthesised
title: '**** Weather Forecast Policy (Anti-Refusal Loop)'
